...
var Stack, Queue;
try {
  Stack = require('../../challenges/stack-queue.js').Stack;
  Queue = require('../../challenges/stack-queue.js').Queue;
} catch (e) {
  console.log('stack-queue could not be tested');
}

if (typeof Stack === 'function' && typeof Queue === 'function') {
  ...
  console.log('Stack and/or Queue were not exported properly');
}
